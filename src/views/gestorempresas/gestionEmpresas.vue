      ...
      <v-card class="pa-3">   
        <v-card-text>
             ...
             <v-row>
                  <v-col cols="6">
                      <v-text-field
                          dense
                          v-model="fpagadoel"
                          label="SE PAGO EN LA FECHA:(DD-MM-YYYY)"
                      ></v-text-field>
                  </v-col>
                  <v-col cols="6">
                      <v-text-field
         ...
         <v-card-actions>
           ...
           <v-dialog     
     v-model="dialogopagoscronograma"
      max-width="490"
      >
    <div>
      <v-system-bar window dark>
...
<script>
import { grabaNotificacion,grabaCronogramapago,allCronogramapago,
grabapagocronograma,guardaArchivo } from '../../db'
