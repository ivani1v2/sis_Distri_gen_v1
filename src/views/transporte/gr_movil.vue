    ...
    <div class="mb-6 pa-4 mt-3">
        ...
        <div>
            <v-stepper v-model="e1">
                ...
                <v-stepper-content v-for="n in steps" :key="`${n}-content`" :step="n" class="pa-1">
                    <div v-if="n == 1">
                        <v-row class="mx-auto text-center pa-1 mt-1" dense>
                            <v-col cols="12">
                                <v-select style="font-size:13.5px" outlined dense v-model="tipo_guia"
                                    :items="array_tipo_guia" menu-props="auto" hide-details
                                    label="TIPO DE GUIA"></v-select>
                            </v-col>
                            <v-col cols="12" class="mx-auto text-center">
                                <v-radio-group v-if="valida_guia" style="font-size:13.5px"
                                    class="mb-n6 mt-1 text-center" dense v-model="modo_transporte" row> Modo
                                    :
                        ...
                        <v-row class="mx-auto text-center mt-n5 mb-2" dense no>
                            <v-col cols="6">
                            ...
                            <v-col cols="6" class="mx-auto text-center">
                                <v-switch v-if="valida_guia" dense v-model="datos_transpor"
                                    label="Datos del Transportista" color="red" hide-details></v-switch>
                        ...
                        <h4 v-if="trans_sub" style="font-size:13.5px" class="mb-1">Empresa Subcontrata</h4>
                        <v-row dense v-if="trans_sub" class="mb-n6">
                            <v-col cols="12" sm="3">
                                <v-text-field style="font-size:13.5px" outlined type="number" dense
                                    v-model="ruc_subcontrata" label="RUC" append-icon="mdi-magnify"
                                    @click:append="buscar_sub()" @keyup.enter="buscar_sub()"></v-text-field>
                        ...
                        <v-row dense v-if="!valida_guia" class="mt-2 mb-n2">
                            <v-col cols="12" sm="6">
                                <v-select style="font-size:13.5px" outlined dense v-model="pagado_por"
                                    :items="array_pagos" menu-props="auto" hide-details
                                    label="Flete pagado por:"></v-select>
                            </v-col>
                            <v-col cols="12" sm="6">
                                <v-text-field style="font-size:13.5px" outlined dense v-model="doc_relacionados"
                                    label="Doc. Relacionados"></v-text-field>
                            </v-col>
                        </v-row>
                        <h4 style="font-size:13.5px" class="mb-1" v-if="valida_guia">Emisor</h4>
                        <h4 style="font-size:13.5px" class="mb-1" v-if="!valida_guia">REMITENTE</h4>
                        <v-row class="text-center" dense :class="$vuetify.breakpoint.smAndDown ? 'mb-n2' : 'mb-n6'">
                            ...
                            <v-col cols="6" sm="3">
                                <v-text-field style="font-size:13.5px" type="date" outlined dense
                                    v-model="date_traslado" :label="texto_fecha"></v-text-field>
                            </v-col>
                            <v-col cols="6" sm="3" :class="$vuetify.breakpoint.smAndDown ? 'mt-n6' : ''">
                                <v-select :disabled="valida_guia" style="font-size:13.5px" outlined dense
                                    v-model="documento" :items="documentos" menu-props="auto" hide-details
                                    label="Tipo Doc"></v-select>
                            </v-col>
                            <v-col cols="6" sm="3" :class="$vuetify.breakpoint.smAndDown ? 'mt-n6' : ''">
                                <v-text-field :disabled="valida_guia" style="font-size:13.5px" outlined type="number"
                                    dense v-model="numero_doc" label="N° Doc" append-icon="mdi-magnify"
                            ...
                            <v-col cols="12" sm="6" :class="$vuetify.breakpoint.smAndDown ? 'mt-n6' : 'mt-n5'">
                                <v-text-field :disabled="valida_guia" style="font-size:13.5px" outlined small dense
                                    v-model="razon_social" label="Razon Social"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" :class="$vuetify.breakpoint.smAndDown ? 'mt-n6' : 'mt-n5'">
                        ...
                        <h4 style="font-size:13.5px" class="mb-1 mt-2">Destinatario</h4>
                    ...
                    <div v-if="n == 2" class="mt-2">

                        <h4 v-if="valida_modo" style="font-size:13.5px" class="mb-1">Datos Transportista
                        ...
                        <v-row v-if="valida_modo" class="text-center mb-n5" dense>
                            <v-col cols="12" sm="3" :class="$vuetify.breakpoint.smAndDown ? '' : ''">
                                <v-text-field style="font-size:13.5px" outlined type="number" dense
                                    v-model="ruc_transporte" label="RUC Transportista" append-icon="mdi-magnify"
                                    @click:append="buscar_transporte()"
                            ...
                            <v-col cols="12">
                                <v-card class="pa-3">
                                    <v-row class="text-center">
                                        ...
                                        <v-col cols="6">
                                            <v-btn block elevation="3" color="info"
                                                @click="dial_agrega_v = !dial_agrega_v" x-small>
                                                <v-icon left>
                                                    mdi-plus
                                                </v-icon>Adicionar
                                            </v-btn>
                                            ...
                                            <tbody>
                                                ...
                                                <tr v-for="item in array_vehiculo" :key="item.placa">
                                                    <td style="font-size:75%">
                                                        <v-icon color="red" @click="eliminar_V(item)"
                            ...
                            <v-col cols="12">
                                <v-card class="pa-3">
                                    ...
                                    <v-row class="text-center">
                                        ...
                                        <v-col cols="6">
                                            <v-btn block elevation="3" color="info"
                                                @click="dial_agrega_c = !dial_agrega_c" x-small>
                                                <v-icon left>
                                                    mdi-plus
                                                </v-icon>Adicionar
                                            </v-btn>
                                        ...
                                        <template v-slot:default>
                                            ...
                                            <tbody>
                                                <tr v-for="item in array_conductor" :key="item.id">
                                                    <td style="font-size:75%">
                                                        <v-icon color="red" @click="eliminar_c(item)"
                                                            small>mdi-close</v-icon>
                        ...
                        <v-row class="mt-1 " dense>
                                ...
                                <v-card class="pa-3 mb-n7">
                                    <v-row dense>
                                        <v-row class="text-left">
                                            <v-col cols="6">
                                                <h4 style="font-size:13.5px">Punto de Partida</h4>
                                            </v-col>
                                            <v-col cols="6">
                                                <v-btn elevation="3" color="info" @click="abre_direcciones('partida')"
                                                    x-small v-if="false">
                                                    <v-icon left>
                                                        mdi-magnify
                                                    </v-icon>Frecuente
                                        ...
                                        <v-col cols="12">
                                            <v-row class="" dense>
                                                <v-col cols="4">
                                                    <v-text-field style="font-size:13.5px" outlined dense
                                                        @click="abredialogo('depa', true)" v-model="departamento_p"
                                                        label="Departamento" readonly></v-text-field>
                                                </v-col>
                                                <v-col cols="4">
                                                    <v-text-field style="font-size:13.5px" outlined dense
                                                        @click="abredialogo('prov', true)" v-model="provincia_p"
                                                        label="Provincia" readonly></v-text-field>
                                                </v-col>
                                                <v-col cols="4">
                                                    <v-text-field style="font-size:13.5px" outlined dense
                                                        @click="abredialogo('distr', true)" v-model="distrito_p"
                                                        label="Distrito" readonly></v-text-field>
                                                </v-col>
                                            </v-row>
                            ...
                            <v-col cols="12">
                                <v-card class="pa-3">
                                    <v-row class="" dense>
                                        <h4 style="font-size:13.5px">Punto de Llegada</h4>
                                        <v-col cols="12">
                                            <v-row class="" dense>
                                                <v-col cols="4">
                                                    <v-text-field style="font-size:13.5px" outlined dense
                                                        @click="abredialogo('depa', false)" v-model="departamento_l"
                                                        label="Departamento" readonly></v-text-field>
                                                </v-col>
                                                <v-col cols="4">
                                                    <v-text-field style="font-size:13.5px" outlined dense
                                                        @click="abredialogo('prov', false)" v-model="provincia_l"
                                                        label="Provincia" readonly></v-text-field>
                                                </v-col>
                                                <v-col cols="4">
                                                    <v-text-field style="font-size:13.5px" outlined dense
                                                        @click="abredialogo('distr', false)" v-model="distrito_l"
                                                        label="Distrito" readonly></v-text-field>
                                                </v-col>
                                            </v-row>
                                            <v-textarea :class="$vuetify.breakpoint.smAndDown ? 'mt-n6' : 'mt-n5'"
                    ...
                    <div v-if="n == 3" class="mt-2">
                        <v-row class="mb-1" dense>
                            <v-col cols="6">
                                <v-select outlined dense v-model="medida_t" :items="array_medidas" menu-props="auto"
                                    hide-details label="Medida"></v-select>
                            </v-col>
                            <v-col cols="6">
                                <v-text-field outlined dense v-model="peso" type="number"
                                    label="Peso Total"></v-text-field>
                            </v-col>
                        ...
                        <v-simple-table fixed-header height="30vh" dense class="">
                            <template v-slot:default>
                    ...
                    <v-row class="mb-1 mx-auto" dense>
                        <v-col cols="4" class="text-left" v-if="e1 != 1">
                            <v-btn small color="error" @click="returStep(n)"> Regresar </v-btn>
                        </v-col>
                        <v-col cols="4" v-if="e1 == 3">
                            <v-btn block elevation="3" color="success" @click="vista_previa()" small>
                                <v-icon left>
                                    mdi-eye
                                </v-icon>vista
                            </v-btn>
                        </v-col>
                        <v-col cols="4" class="text-right" v-if="e1 == 3">
                        ...
                        <v-col cols="4" class="text-right" v-if="e1 != 3">
                            <v-btn small color="primary" @click="nextStep(n)">
                                Siguiente
                            </v-btn>
                        </v-col>
        ...
        <v-dialog v-model="dial_agrega" max-width="550">
            <div>
                <v-system-bar window dark>
            ...
            <v-card class="pa-6">
                <v-row dense :class="$vuetify.breakpoint.smAndDown ? 'mb-n6' : 'mb-n6'">
                    ...
                    <v-col cols="12" sm="3" :class="$vuetify.breakpoint.smAndDown ? 'mt-n6' : ''">
                        <v-select outlined dense v-model="medida" :items="$store.state.medidas" menu-props="auto"
                            hide-details label="Medida"></v-select>
                    </v-col>
                    <v-col cols="12" sm="5" :class="$vuetify.breakpoint.smAndDown ? '' : ''">
...
import transportista from '@/views/transporte/transportista'
import {
    guia_remision
} from '../../servidorsunat'
import {
...
export default {
    ...
    created() {
        if (store.state.array_guia) {
            console.log(store.state.array_guia)
            var detalle = store.state.array_guia.array_item
            var cabecera = store.state.array_guia.arrayCabecera
            ...
            this.u_origen = store.state.baseDatos.ubigeo
            this.dir_p = store.state.baseDatos.direccion
            this.departamento_p = store.state.baseDatos.departamento
            this.provincia_p = store.state.baseDatos.provincia
            this.distrito_p = store.state.baseDatos.distrito
    ...
    methods: {
        ...
        abredialogo(ubica, modo) {
            this.ubicacion_partida = modo
            this.arrayubica = []
            switch (ubica) {
                case 'depa':
        ...
        seleccionaUbica(item) {
            if (this.ubicacion_partida) {
                switch (this.tipoubicacion) {
                    case 1:
                        this.departamento_p = item.nombre.toUpperCase()
                        this.ubigeodepa = item.ubigeo
                        this.ubigeo1 = item.ubigeo_sunat
                        break;
                    case 2:
                        this.provincia_p = item.nombre.toUpperCase()
                        this.ubigeoprov = item.ubigeo
                        this.ubigeo2 = item.ubigeo_sunat
                        break;
                    case 3:
                        this.distrito_p = item.nombre.toUpperCase()
                        this.ubigeoselecto = item.ubigeo
                        this.ubigeo3 = item.ubigeo_sunat
                        this.u_origen = this.ubigeo1 + this.ubigeo2 + this.ubigeo3
                        break;
                    default:
                        break;
                }
                ...
                switch (this.tipoubicacion) {
                    case 1:
                        this.departamento_l = item.nombre.toUpperCase()
                        this.ubigeodepa = item.ubigeo
                        this.ubigeo1 = item.ubigeo_sunat
                        break;
                    case 2:
                        this.provincia_l = item.nombre.toUpperCase()
                        this.ubigeoprov = item.ubigeo
                        this.ubigeo2 = item.ubigeo_sunat
                        break;
                    case 3:
                        this.distrito_l = item.nombre.toUpperCase()
                        this.ubigeoselecto = item.ubigeo
                        this.ubigeo3 = item.ubigeo_sunat
                        this.u_destino = this.ubigeo1 + this.ubigeo2 + this.ubigeo3
                        break;
                    default:
                        break;
                }
            }
            console.log(this.u_origen, this.u_destino)
        ...
        async vista_previa() {
            ...
            var array = {
                ...
                departamento_p: this.departamento_p,
                provincia_p: this.provincia_p,
                distrito_p: this.distrito_p,
                ...
                departamento_l: this.departamento_l,
                provincia_l: this.provincia_l,
                distrito_l: this.distrito_l,
                ...
                doc_relacionados: this.doc_relacionados
            }
            this.item_selecto = array
        ...
        async genera_pdf(modo) {
            store.commit("dialogoprogress")
            generaGuia(this.item_selecto, 'A4')
