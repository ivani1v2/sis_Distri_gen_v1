    ...
    <template v-slot:default >
      ...
      <tbody >
        <tr
          ...
          :key="item.id"
          @click="dialogDelete= !dialogDelete, id =item.id"
        >
          <td >{{ item.id }}</td>
          <td>{{ item.nombre }}</td>
...
<script>
import { buscaProductos,grabarStockOtraBase,nuevoProductoOtraBase,
grabarStock,allProductoOtraBase} from '../db'
